...
from svp.mimic.models import MODELS
from svp.mimic.datasets import DATASETS
from svp.mimic.train import train as train_function
from svp.mimic.active import active as active_function
from svp.mimic.coreset import coreset as coreset_function
...
def dataset_options(func):
    ...
    decorators = [
        ...
        click.option('--dataset', '-d', type=click.Choice(DATASETS),
                     default='mimic_cf', show_default=True,
